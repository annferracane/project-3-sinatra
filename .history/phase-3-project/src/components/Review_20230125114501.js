...
function Review({ review, deleteReview }) {
    ...
    function discardChanges() {
        const [header, setHeader] = setHeader(review.header);
    const [comment, setComment] = setComment(review.comment);
    const [starRating, setStarRating] = setStarRating(review.star_rating);
