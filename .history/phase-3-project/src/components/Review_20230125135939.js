...
function Review({ review, deleteReview, editReview }) {
    ...
    // Returns value of whether user is logged in AND if user is the same as reviewer
    ...
    function deleteHandler() {
        ...
        .then(data => deleteReview(reviewId))
        .catch(e => console.log(e));
    }

    // Edit review handler (begin editing
    function editHandler() {
        setEditMode(!editMode);
    }

    // Save Edited Review (save edit)
    ...
    // Shows static review that cannot be edited
    const notEditMode = (
        <div className="feature col">
            <div className="feature-icon d-inline-flex align-items-center justify-content-center fs-2 mb-3">
                <img src={ review.cereal.image_url } className='img-fluid' style={{ height: "60px" }} alt={ review.cereal.cereal_name }/>
