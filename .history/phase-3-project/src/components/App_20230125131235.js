...
function App() {
  ...
  function performEditReview(editedReview){
    ...
    <div className="App">
      <UserProvider>
        ...
        <Routes>
          ...
          <Route path={"/reviews"} element={<><Reviews reviews={ reviews } deleteReview={ deleteReview } performEditReview={ performEditReview} editReview={ editReview }/></>} />
