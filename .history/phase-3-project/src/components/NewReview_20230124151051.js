                ...
                <div className="p-5 text-bg-dark rounded-3">
                    <form onSubmit={ handleSubmit }>
                        <div className="form-group">
                            ...
                            <select className="form-select" value={ cerealId } onChange={(e) => setCerealId(e.target.value.toI)} aria-label="Default select example">
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-select" value={ starRating } onChange={(e) => setStarRating(e.target.value)} aria-label="Default select example">
