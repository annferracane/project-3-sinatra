...
function NewReview({ addNewReview }) {
    ...
    const [cerealId, setCerealId] = useState('');
                ...
                <div className="p-5 text-bg-dark rounded-3">
                    <form onSubmit={ handleSubmit }>
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" id="title-Input" value={ cerealId } onChange={(e) => setCerealName(e.target.value)} />
                            <select className="form-select" value={ cerealId } aria-label="Default select example">
