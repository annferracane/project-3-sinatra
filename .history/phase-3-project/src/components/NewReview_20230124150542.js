                ...
                <div className="p-5 text-bg-dark rounded-3">
                    <form onSubmit={ handleSubmit }>
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-select" value={ cerealId } onChange={(e) => setCerealId(e.target.value)} aria-label="Default select example">
                                <option value="0" selected>Select Cereal to Review</option>
                                <option value="1">Select Cereal to Review</option>
                                <option value="2">Select Cereal to Review</option>
                                <option value="3">Select Cereal to Review</option>
                                <option value="4">Select Cereal to Review</option>
                                <option value="5">Select Cereal to Review</option>
                            </select>
                        </div>
                        <br></br>
